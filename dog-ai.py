...
Image('dataset\\train\\0a0c223352985ec154fd604d7ddceabd.jpg')

filenames = ['dataset\\train\\' + fname + '.jpg' for fname in labels_csv['id']]
filenames[:5]

import os
if len(os.listdir('dataset\\train')) == len(filenames):
...
preds_df.to_csv("MySubmission.csv",
                 index=False)
